...
2. 打开微信，点右下角 **我** → **设置** → **世界**
3. 进入世界后，点 **插件**
4. 在插件列表中找到 **微信ClawBot**，启用
5. 按页面提示完成授权（会生成一个专属 bot，扫码绑定）
6. 完成后，微信消息首页会出现一个 AI 对话窗口，这就是你的 bot

> 界面可能因微信版本不同略有差异，以实际 App 显示为准。
...
2. Open WeChat → tap **Me** (bottom right) → **Settings** → **世界 (World)**
3. Tap **插件 (Plugins)**
4. Find **微信ClawBot** in the plugin list and enable it
5. Follow the on-screen instructions to authorize (this creates a dedicated bot and links it via QR scan)
6. Once done, an AI chat window appears in your WeChat message list — that's your bot

> The exact UI may vary slightly depending on your WeChat version.
